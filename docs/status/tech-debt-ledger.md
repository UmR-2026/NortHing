...
- **Status**: resolved (2026-09-09, W22-1: live 提示已通 — kernel 桥 Banner + desktop streaming banner + CLI 打印；提案 (3) 历史落痕经评估为 YAGNI 主动放弃——压缩是常规背景事件，live banner 已满足可见性，历史标记只增噪声；编排者口径，用户可推翻)
