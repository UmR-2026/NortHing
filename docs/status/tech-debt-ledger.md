...
- **Status**: `resolved` — violations cleared to 0 (`d621b29`, 2026-07-23: final 17 violations → 0; `node scripts/core-boundaries/checker.mjs` exits 0 with zero violations, verified 2026-07-27). Stage 1-2 history: 230 → 37 → 0 across 2026-07-23. **Remaining**: stage 3 — wire checker into CI (not yet done; checker is not in any workflow file).
