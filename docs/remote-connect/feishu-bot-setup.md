...
Use this guide to pair northhing through a Feishu bot.
...
Open northhing and start the Feishu bot connection:
...
Enter the 6-digit pairing code shown in northhing Desktop, send it, and wait for the connection to succeed.
