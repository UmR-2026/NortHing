...
| `birth` | `oklch(0.8773 0.0105 81.79)` | `#DAD6CF` | `oklch(0.3897 0.0169 78.09)` | `#4A443B` | 出生灰白锚（编年史条最左端） <- #DAD6CF (theme-system.html L17) |
| `scrim` | `oklch(0.3297 0.0127 87.56)` | `#38352E` | `oklch(0 0 0)` | `#000000` | 遮罩暗化基底 <- #38352E (settings-general.html L225 亮态阴影 rgba(56,53,46,·)) |
| `shadow` | `oklch(0.3297 0.0127 87.56)` | `#38352E` | `oklch(0 0 0)` | `#000000` | 阴影投射色 <- #38352E (settings-general.html L225/417/476 亮态阴影 rgba(56,53,46,·)) |
...
| `birth` | `#DAD6CF` | `#DAD6CF` | 0 |
| `scrim` | `#38352E` | `#38352E` | 0 |
| `shadow` | `#38352E` | `#38352E` | 0 |
