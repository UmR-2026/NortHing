...
Thanks for your interest in northhing! northhing is a multi-platform AI programming environment powered by Rust and TypeScript, with shared core logic across Desktop/CLI/Server. This guide explains how to contribute effectively.
...
webview DevTools. `Cmd/Ctrl + Shift + I` toggles the northhing element inspector,
