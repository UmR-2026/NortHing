...
5. `node scripts/verify-rot-budget.mjs --base 9222bbc42c2b0a13961dd8e63686c3c804abe698` → exit 0（god_file lsp/manager.rs 读数须 <836——净减实证）
6. `node scripts/verify-task-gate.mjs verify-attempt --base 9222bbc42c2b0a13961dd8e63686c3c804abe698 --tip <本单最后 commit sha> --allowlist .superpowers/sdd/w26-4-allowlist.txt` → exit 0（自建 allowlist 含自身；**窗口内若出现其它 W26 单文件，停手报编排者复跑**）
