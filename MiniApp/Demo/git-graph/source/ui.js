/* ui/state.js */
/**
 * Git Graph MiniApp 鈥?shared state, constants, DOM helpers.
 */
(function () {
...
/* ui/theme.js */
/**
 * Git Graph MiniApp 鈥?theme adapter: read --branch-* and node stroke from CSS for graph colors.
 */
(function () {
  window.__GG = window.__GG || {};
  ...
  window.__GG.getNodeStroke = function () {
    return getComputed('--graph-node-stroke') || getComputed('--northhing-bg') || getComputed('--bg') || '#0d1117';
  };
...
/* ui/graph/layout.js */
/**
 * Git Graph MiniApp 鈥?global topology graph layout (Vertex/Branch/determinePath).
...
/**
 * Git Graph MiniApp 鈥?build SVG for one commit row (theme-aware colors).
 */
(function () {
  window.__GG = window.__GG || {};
...
/**
 * Git Graph MiniApp 鈥?worker call wrapper.
 */
(function () {
  window.__GG = window.__GG || {};
...
/**
 * Git Graph MiniApp 鈥?context menu.
 */
(function () {
  window.__GG = window.__GG || {};
  const $ = window.__GG.$;
...
/**
 * Git Graph MiniApp 鈥?modal dialog.
 */
(function () {
  window.__GG = window.__GG || {};
  const $ = window.__GG.$;
...
/**
 * Git Graph MiniApp 鈥?find widget and branch filter dropdown.
 */
(function () {
  window.__GG = window.__GG || {};
  const state = window.__GG.state;
...
/**
 * Git Graph MiniApp 鈥?remote panel.
 */
(function () {
  window.__GG = window.__GG || {};
  const state = window.__GG.state;
...
/**
 * Git Graph MiniApp 鈥?detail panel (commit / compare).
 */
(function () {
  window.__GG = window.__GG || {};
  const state = window.__GG.state;
...
/* ui/main.js */
/**
 * Git Graph MiniApp 鈥?commit list, context menus, git actions, loadRepo.
 */
(function () {
  window.__GG = window.__GG || {};
  const state = window.__GG.state;
...
/* ui/bootstrap.js */
/**
 * Git Graph MiniApp 鈥?bootstrap: bind events, init resizer, restore last repo, theme subscription.
 */
(function () {
  window.__GG = window.__GG || {};
  const state = window.__GG.state;
