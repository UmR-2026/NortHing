...
const MOBILE_INSTALL_ID_KEY = 'northhing.mobile.install_id';
const MOBILE_USER_ID_KEY = 'northhing.mobile.user_id';
const MOBILE_LOCK_UNTIL_KEY = 'northhing.mobile.user_id_lock_until';
const MOBILE_FAILURE_COUNT_KEY = 'northhing.mobile.user_id_failure_count';
