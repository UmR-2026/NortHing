...
const STORAGE_KEY = 'northhing-mobile-theme';
const THEME_STYLE_ATTR = 'data-northhing-theme';
...
function commitThemeDOM(id: ThemeId) {
  ...
  //    This is the most reliable cross-browser path 鈥?it guarantees
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useLayoutEffect(() => {
    ...
    if (isSwitch) {
      ...
      // BEFORE we change CSS variable values 鈥?otherwise the start and
