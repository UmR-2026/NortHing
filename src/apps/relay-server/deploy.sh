#!/usr/bin/env bash
# northhing Relay Server 鈥?one-click deploy script.
...
usage() {
  cat <<'EOF'
northhing Relay Server deploy script
...
echo "=== northhing Relay Server Deploy ==="
...
echo ""
echo "Custom Server URL examples for northhing Desktop:"
