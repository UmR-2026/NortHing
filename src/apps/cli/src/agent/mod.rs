...
///
/// Wraps interaction with northhing-core's Agentic system.
...
// reason: Agent trait scaffolding kept for future agent-type-specific CLI adapters (today callers use CoreAgentAdapter directly)
#[allow(dead_code)]
