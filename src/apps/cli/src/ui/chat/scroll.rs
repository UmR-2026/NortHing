impl ChatView {
    pub fn clear_screen(&mut self) {
        ...
        self.selection.collapsed_tools.clear();
        self.selection.focused_block_tool = None;
        self.selection.collapsed_thinking.clear();
        self.selection.thinking_auto_collapsed.clear();
        self.selection.thinking_user_overrides.clear();
    ...
    pub fn cancel_theme_preview(&mut self) {
        ...
        self.mouse.pending_theme_preview = None;
    }
