...
use crate::ui::model_selector::{model_display_name, PRIMARY_SENTINEL};
...
impl ChatMode {
    ...
    pub(crate) fn load_current_model_name(&self, chat_state: &mut ChatState, rt_handle: &tokio::runtime::Handle) {
        ...
        let result: Option<String> = bridge(rt_handle, async {
            ...
            // Find model name
            let model_name = if model_id == PRIMARY_SENTINEL {
