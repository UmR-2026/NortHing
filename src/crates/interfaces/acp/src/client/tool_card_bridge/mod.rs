...
pub(super) fn normalize_tool_params(tool_name: &str, params: serde_json::Value) -> serde_json::Value {
...
mod tests {
    ...
    fn normalizes_file_tools_to_native_cards() {
        ...
        assert_eq!(normalize_tool_params("Read", read_input)["file_path"], "src/main.rs");
    ...
    fn normalizes_search_tools_to_grep_or_glob_cards() {
        ...
        assert_eq!(normalize_tool_params("Grep", grep_input)["pattern"], "AcpClientService");
        ...
        assert_eq!(normalize_tool_params("Glob", glob_input)["pattern"], "**/*.rs");
    }
    ...
    fn normalizes_camel_case_file_params() {
        ...
        assert_eq!(acp_tool_name("Edit file", Some(&input), Some(&ToolKind::Edit)), "Edit");
