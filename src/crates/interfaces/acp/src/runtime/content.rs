use agent_client_protocol::schema::{
    Annotations, BlobResourceContents, ContentBlock, EmbeddedResourceResource, ImageContent, ResourceLink, Role,
    TextResourceContents,
};
use northhing_core::agentic::image_analysis::ImageContextData;
            ...
            ContentBlock::Resource(resource) => {
                ...
                match resource.resource {
                    ...
                    EmbeddedResourceResource::BlobResourceContents(blob) => {
                        if let Some(context) = blob_resource_to_image_context(session_id, index, &blob) {
                    ...
                    _ => {
                        text_parts.push("[Embedded resource omitted: unsupported resource type]".to_string());
                    }
                }
            }
...
fn image_to_context(session_id: &str, index: usize, image: ImageContent) -> Option<ImageContextData> {
