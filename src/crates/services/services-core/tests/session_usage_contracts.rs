use northhing_services_core::session_usage::{
    classify_tool_usage, display_workspace_relative_path, render_usage_report_terminal, SessionUsageReport,
    UsageToolCategory,
};
...
fn usage_path_redaction_preserves_workspace_relative_display() {
    let label = display_workspace_relative_path(Some("D:/workspace/northhing"), "D:/workspace/northhing/src/main.rs");
