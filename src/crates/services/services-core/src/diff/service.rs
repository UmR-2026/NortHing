...
impl DiffService {
    ...
    pub fn compute_diff_with_options(&self, original: &str, modified: &str, options: &DiffOptions) -> DiffResult {
                    ...
                    DiffOp::Equal {
                        ...
                        for i in 0..*len {
                            hunk_lines.push(DiffLine {
                                ...
                                content: original_lines.get(*old_index + i).unwrap_or(&"").to_string(),
                    ...
                    DiffOp::Insert { new_index, new_len, .. } => {
                        ...
                        for i in 0..*new_len {
                            hunk_lines.push(DiffLine {
                                ...
                                content: modified_lines.get(*new_index + i).unwrap_or(&"").to_string(),
