    ...
    pub fn partial_unavailable(session_id: impl Into<String>, generated_at: i64) -> Self {
        Self {
            ...
            coverage: UsageCoverage {
                ...
                available: vec![],
                missing: vec![UsageCoverageKey::CachedTokens, UsageCoverageKey::TokenDetailBreakdown],
                notes: vec![
...
pub(crate) fn test_report() -> SessionUsageReport {
    ...
    report.workspace = UsageWorkspace {
        ...
        path_label: Some("D:/workspace/northhing".to_string()),
    ...
    report.coverage.missing = vec![UsageCoverageKey::CachedTokens, UsageCoverageKey::TokenDetailBreakdown];
...
mod tests {
    ...
    fn session_usage_report_round_trips_with_workspace_scope_and_privacy() {
        ...
        report.privacy.redacted_fields.push("slowest.label".to_string());
