...
pub fn display_workspace_relative_path(workspace_root: Option<&str>, raw_path: &str) -> RedactedLabel {
...
mod tests {
    ...
    fn display_workspace_relative_path_keeps_workspace_relative_label() {
        let label =
            display_workspace_relative_path(Some("D:/workspace/northhing"), "D:/workspace/northhing/src/main.rs");
