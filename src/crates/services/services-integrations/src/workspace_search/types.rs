...
use super::flashgrep::{
    DirtyFileStats as FlashgrepDirtyFileStats, FileCount as FlashgrepFileCount, FileMatch as FlashgrepFileMatch,
    MatchLocation as FlashgrepMatchLocation, RepoPhase as FlashgrepRepoPhase, RepoStatus as FlashgrepRepoStatus,
    SearchBackend as FlashgrepSearchBackend, SearchHit as FlashgrepSearchHit, SearchLine as FlashgrepSearchLine,
    SearchModeConfig, TaskKind as FlashgrepTaskKind, TaskPhase as FlashgrepTaskPhase, TaskState as FlashgrepTaskState,
...
impl From<FlashgrepSearchBackend> for WorkspaceSearchBackend {
    fn from(value: FlashgrepSearchBackend) -> Self {
        match value {
            FlashgrepSearchBackend::IndexedSnapshot | FlashgrepSearchBackend::IndexedClean => Self::Indexed,
...
impl From<FlashgrepSearchLine> for WorkspaceSearchLine {
    fn from(value: FlashgrepSearchLine) -> Self {
        match value {
            FlashgrepSearchLine::Match { value } => Self::Match { value: value.into() },
            FlashgrepSearchLine::Context { line_number, snippet } => Self::Context {
                value: WorkspaceSearchContextLine { line_number, snippet },
            },
