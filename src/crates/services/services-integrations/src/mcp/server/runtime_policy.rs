...
pub fn detect_mcp_list_changed_kind(method: &str) -> Option<MCPListChangedKind> {
    match method {
        "notifications/tools/list_changed" | "notifications/tools/listChanged" | "tools/list_changed" => {
            Some(MCPListChangedKind::Tools)
        }
        "notifications/prompts/list_changed" | "notifications/prompts/listChanged" | "prompts/list_changed" => {
            Some(MCPListChangedKind::Prompts)
        }
        "notifications/resources/list_changed" | "notifications/resources/listChanged" | "resources/list_changed" => {
