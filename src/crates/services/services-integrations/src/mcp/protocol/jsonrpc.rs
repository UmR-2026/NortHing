...
pub fn create_initialize_request(
    ...
    let params = McpInitializeParams {
        ...
        client_info: MCPServerInfo {
            ...
            description: Some("northhing MCP Client".to_string()),
            vendor: Some("northhing".to_string()),
        },
    };
...
pub fn create_resources_list_request(id: u64, cursor: Option<String>) -> MCPRequest {
    ...
    MCPRequest::new(Value::Number(id.into()), "resources/list".to_string(), params)
}
...
pub fn create_tools_call_request(id: u64, name: impl Into<String>, arguments: Option<Value>) -> MCPRequest {
...
pub fn create_ping_request(id: u64) -> MCPRequest {
    MCPRequest::new(Value::Number(id.into()), "ping".to_string(), Some(json!({})))
}
    ...
    T: serde::de::DeserializeOwned,
{
    ...
    serde_json::from_value(result.clone())
        .map_err(|e| MCPRuntimeError::deserialization(format!("Failed to parse MCP response: {}", e)))
}
