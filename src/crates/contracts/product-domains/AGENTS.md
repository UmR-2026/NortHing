...
`northhing-product-domains` owns platform-agnostic product-domain contracts that can
...
- Do not add a dependency from `northhing-product-domains` to `northhing-core`.
