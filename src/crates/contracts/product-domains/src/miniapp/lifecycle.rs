...
pub fn build_created_app(id: String, input: MiniAppCreateInput, compiled_html: String, now: i64) -> MiniApp {
    let version = 1;
...
pub fn apply_update_patch(previous: &MiniApp, patch: MiniAppUpdatePatch, compiled_html: String, now: i64) -> MiniApp {
...
pub fn apply_draft_source_sync_result(mut app: MiniApp, compiled_html: String, now: i64) -> MiniApp {
    app.updated_at = now;
    app.compiled_html = compiled_html;
...
pub fn apply_draft_to_active(current: &MiniApp, draft: MiniApp, compiled_html: String, now: i64) -> MiniApp {
