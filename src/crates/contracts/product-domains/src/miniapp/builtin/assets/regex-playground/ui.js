...
Project: https://github.com/UmR-2026/northhing
...
const I18N = {
  'zh-CN': {
    ...
    statusHits: (n) => `命中 ${n} 处`,
    matchCount: (n) => `${n} 处匹配`,
    matchCountInvalid: '“处匹???,
    summaryWaiting: '尚未匹配',
    summaryNoMatch: '无匹???,
    summaryWithGroups: (n, g) => `${n} ???· ${g} 个分组`,
    ...
    cheatsheet_grouped: [
      ['<code>\\d</code> 数字 · <code>\\D</code> 非数???],
      ['<code>\\w</code> 字母数字下划???· <code>\\W</code> 反之'],
      ['<code>\\s</code> 空白 · <code>\\S</code> 非空???],
      ['<code>^ $</code> 行首/行尾（配???m???],
      ['<code>(?:“</code> 非捕???· <code>(?&lt;n&gt;“</code> 命名捕获'],
      ['<code>(?=“</code> 正向先行 · <code>(?!“</code> 反向先行'],
      ['<code>{n,m}</code> 区间量词 · <code>?</code> 非贪???],
    ],
  },
  'zh-TW': {
    title: '正則遊樂???,
    ...
    statusHits: (n) => `命中 ${n} 處`,
    matchCount: (n) => `${n} 處匹配`,
    matchCountInvalid: '“處匹???,
    summaryWaiting: '尚未匹配',
    summaryNoMatch: '無匹???,
    summaryWithGroups: (n, g) => `${n} ???· ${g} 個分組`,
    ...
    cheatsheet_grouped: [
      ['<code>\\d</code> 數字 · <code>\\D</code> 非數???],
      ['<code>\\w</code> 字母數字下劃???· <code>\\W</code> 反之'],
      ['<code>\\s</code> 空白 · <code>\\S</code> 非空???],
      ['<code>^ $</code> 行首/行尾（配???m???],
      ['<code>(?:“</code> 非捕???· <code>(?&lt;n&gt;“</code> 命名捕獲'],
      ['<code>(?=“</code> 正向先行 · <code>(?!“</code> 反向先行'],
      ['<code>{n,m}</code> 區間量???· <code>?</code> 非貪???],
    ],
  },
