...
use crate::miniapp::bridge_builder::{
    build_bridge_script, build_csp_content, build_import_map, build_miniapp_default_theme_css, scroll_boundary_script,
};
...
mod tests {
    ...
    fn compile_request_from_paths_preserves_runtime_paths() {
        ...
        let request = MiniAppCompileRequest::from_paths("app-1", &app_data_dir, Some(&workspace_root), "dark");
