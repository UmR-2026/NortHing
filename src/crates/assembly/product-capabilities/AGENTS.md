...
`northhing-product-capabilities` owns product capability pack assembly facts: which
...
- Do not depend on `northhing-core`, app crates, Tauri, product-domain
...
```bash
cargo test -p northhing-product-capabilities
