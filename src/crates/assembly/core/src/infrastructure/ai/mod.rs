...
pub use northhing_ai_adapters::providers;
pub use northhing_ai_adapters::stream as ai_stream_handlers;

pub use client_factory::{get_global_ai_client_factory, initialize_global_ai_client_factory, AIClientFactory};
pub use northhing_ai_adapters::{
...
pub fn build_stream_options_for_model(config: &AIConfig, model_config: Option<&AIModelConfig>) -> StreamOptions {
