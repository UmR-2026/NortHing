 ...
 */
pub use northhing_product_domains::function_agents::git_func_agent::types;
pub mod utils;
...
impl GitFunctionAgent {
    ...
    pub async fn generate_commit_message(
        ...
        CoreProductDomainRuntime::generate_function_agent_commit_message(self.factory.clone(), repo_path, options).await
    }
