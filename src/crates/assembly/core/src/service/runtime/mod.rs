...
//!
//! Provides:
//! - command capability snapshot (system vs northhing-managed runtime)
...
impl RuntimeManager {
    ...
    pub fn capabilities(&self) -> Vec<RuntimeCommandCapability> {
