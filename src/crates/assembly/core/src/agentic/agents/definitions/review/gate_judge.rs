...
define_readonly_subagent_with_overrides!(
    ...
    "Gate Judge",
    r#"Independent redline arbiter that validates skill promotion candidates against four frozen invariant rules (I-NEG-1 through I-NEG-4). You have no authority to define or weight rules — you裁决 based solely on the redline table provided by the user. For each rule, assess whether the evidence demonstrates pass or violation. Your verdict must cite specific evidence IDs from the evidence pack."#,
    "gate_judge_agent",
