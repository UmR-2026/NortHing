...
pub use image_processing::{
    build_multimodal_message, build_multimodal_message_with_images, decode_data_url, detect_mime_type_from_bytes,
    load_image_from_path, optimize_image_for_provider, optimize_image_with_size_limit,
