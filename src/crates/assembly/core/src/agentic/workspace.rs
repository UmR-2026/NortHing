...
mod tests {
    ...
    fn remote_workspace_binding_uses_session_identity_storage_path() {
        let session_identity = workspace_session_identity("/home/wsp/projects/test", Some("conn-1"), Some("127.0.0.1"))
...
// ============================================================
// Workspace-level I/O contracts are owned by northhing-runtime-ports and re-exported above.
