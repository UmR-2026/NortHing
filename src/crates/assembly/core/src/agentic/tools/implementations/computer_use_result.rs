...
mod tests {
    use super::*;
    use crate::agentic::tools::computer_use_host::{ComputerUseImageContentRect, ComputerUseInteractionScreenshotKind};
    ...
    fn screenshot_body_keeps_existing_fields_and_adds_interaction_state() {
        ...
        assert_eq!(body["interaction_state"]["last_screenshot_kind"], json!("full_display"));
