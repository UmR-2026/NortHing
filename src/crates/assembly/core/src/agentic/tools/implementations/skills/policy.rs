...
pub fn policy_for_mode(mode_id: &str) -> ModeSkillPolicy {
    ...
    match SkillModeId::parse(policy_scope.as_ref()) {
        ...
        SkillModeId::ComputerUse | SkillModeId::DeepResearch | SkillModeId::Other => OPEN_META_ONLY_POLICY,
    }
}
...
mod tests {
    ...
    fn builtin_defaults_follow_mode_policies() {
        ...
        assert_eq!(SkillModeId::parse("coding_shared"), SkillModeId::CodingShared);
        ...
        assert_eq!(resolve_builtin_default_enabled("ppt-design", "agentic"), Some(false));
        assert_eq!(resolve_builtin_default_enabled("ppt-design", "Cowork"), Some(true));
        ...
        assert_eq!(resolve_builtin_default_enabled("pdf", "coding_shared"), Some(false));
