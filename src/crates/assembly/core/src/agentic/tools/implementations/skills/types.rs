...
impl SkillData {
    ...
    pub fn from_markdown(
        ...
        let name = metadata
            ...
            .and_then(|v| v.as_str())
            .map(|s| s.to_string())
            .ok_or_else(|| NortHingError::tool("Missing required field 'name' in SKILL.md".to_string()))?;

        let description = metadata
            .get("description")
            .and_then(|v| v.as_str())
            .map(|s| s.to_string())
            .ok_or_else(|| NortHingError::tool("Missing required field 'description' in SKILL.md".to_string()))?;
