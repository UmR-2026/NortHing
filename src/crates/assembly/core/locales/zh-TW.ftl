...
dioxus-room-archive-search-placeholder = 搜尋會議...
dioxus-room-archive-search-clear = 清除
dioxus-room-archive-btn-rename = 重新命名
dioxus-room-archive-btn-delete = 刪除
dioxus-room-archive-btn-export = 匯出
dioxus-room-archive-btn-detail = 查看詳情
dioxus-room-archive-delete-confirm = 確定刪除此會議？此操作無法撤銷。
dioxus-room-archive-delete-forbidden = 目前活躍會議，無法刪除
dioxus-room-archive-rename-placeholder = 輸入新標題
dioxus-room-archive-export-path = 已匯出至：
dioxus-room-archive-export-fail = 匯出失敗：
dioxus-room-archive-rename-fail = 重新命名失敗：
dioxus-room-archive-delete-fail = 刪除失敗：
dioxus-room-archive-empty = 暫無已封存會議
dioxus-room-archive-empty-search = 未找到符合的會議
dioxus-room-archive-load-fail = 載入會議列表失敗：
dioxus-room-archive-subagent-badge = 子任務
...
dioxus-room-settings-mcp-readwrite = 讀寫存取
dioxus-room-settings-mcp-plugin = 哲理外掛
dioxus-room-settings-mcp-unauthorized = 未授權
dioxus-room-settings-workspace-path = E:\agent-project\northing\
dioxus-room-settings-display-breath = 生物態呼吸
dioxus-room-settings-display-breath-period = 8s 週期
dioxus-room-settings-display-dual = 雙光學響應
dioxus-room-settings-display-dual-note = 明暗自動流轉
dioxus-room-settings-sediment-foot = 深淵級 · 封存層
dioxus-room-nav-onboarding = 誕生儀式
dioxus-room-onboarding-window-title = 房間誕生儀式
dioxus-room-onboarding-status-title = 房間誕生儀式 00
dioxus-room-onboarding-status-initial = 沉寂中 · 待注入印記
dioxus-room-onboarding-head-state-initial = 沉寂態 · 等待人類決定第一個色彩
dioxus-room-onboarding-head-name-initial = 未命名診室
dioxus-room-onboarding-head-fold-btn = 收納中樞
dioxus-room-onboarding-drawer-mind-head = 誕生前夜
dioxus-room-onboarding-drawer-facility-head = 設施預備
dioxus-room-onboarding-drawer-work-head = 誕生存根
dioxus-room-onboarding-section-identity-title = 身分印記
dioxus-room-onboarding-section-identity-em = IDENTITY
dioxus-room-onboarding-section-provider-title = 設施接入
dioxus-room-onboarding-section-provider-em = PROVIDER
dioxus-room-onboarding-section-workspace-title = 物理邊界
dioxus-room-onboarding-section-workspace-em = WORKSPACE
dioxus-room-onboarding-step-1 = 步驟 I / III
dioxus-room-onboarding-step-2 = 步驟 II / III
dioxus-room-onboarding-step-3 = 步驟 III / III
dioxus-room-onboarding-label-user = 使用者是【】
dioxus-room-onboarding-label-agent = 你是【】
dioxus-room-onboarding-label-relation = 你是使用者的【】
dioxus-room-onboarding-label-palette = 性格色板 = 大五
dioxus-room-onboarding-label-palette-em = MIND PALETTE（人類唯一可改色入口）
dioxus-room-onboarding-label-model = 模型 ENGINE
dioxus-room-onboarding-label-base-url = 基底網址 BASE URL
dioxus-room-onboarding-label-api-key = 金鑰 API KEY
dioxus-room-onboarding-label-workspace = 工作資料夾 ROOT DIRECTORY
dioxus-room-onboarding-btn-test = ↯ 測定心跳脈衝
dioxus-room-onboarding-test-status-wait = 等待測試訊號...
dioxus-room-onboarding-btn-browse = 瀏覽...
dioxus-room-onboarding-btn-complete = ☩ 喚醒診室 · 開啟印記
dioxus-room-onboarding-preview-uncolored = 未著色 (灰)

# ===== W9-6 檔案樹 / 預覽（右側面板）=====
dioxus-room-files-section-title = 工作目錄
dioxus-room-files-section-em = FILES
dioxus-room-files-empty = 暫無檔案
dioxus-room-files-loading = 正在讀取目錄...
dioxus-room-files-load-fail = 列表讀取失敗
dioxus-room-files-preview-placeholder = 選中檔案後預覽內容
dioxus-room-files-preview-loading = 正在載入預覽...
dioxus-room-files-preview-empty = （空檔案）
dioxus-room-files-preview-binary = 二進位檔案不支援預覽
dioxus-room-files-preview-too-large = 檔案過大，無法預覽
dioxus-room-files-preview-not-found = 檔案不存在
dioxus-room-files-preview-fail = 預覽載入失敗