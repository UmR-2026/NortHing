...
dioxus-room-status-pill = architect_sub intervening
...
dioxus-room-archive-search-placeholder = Search sessions...
dioxus-room-archive-search-clear = Clear
dioxus-room-archive-btn-rename = Rename
dioxus-room-archive-btn-delete = Delete
dioxus-room-archive-btn-export = Export
dioxus-room-archive-btn-detail = Detail
dioxus-room-archive-delete-confirm = Delete this session? This action cannot be undone.
dioxus-room-archive-delete-forbidden = Active room session, cannot delete
dioxus-room-archive-rename-placeholder = New title
dioxus-room-archive-export-path = Exported to:
dioxus-room-archive-export-fail = Export failed:
dioxus-room-archive-rename-fail = Rename failed:
dioxus-room-archive-delete-fail = Delete failed:
dioxus-room-archive-empty = No archived sessions
dioxus-room-archive-empty-search = No matching sessions
dioxus-room-archive-load-fail = Failed to load sessions:
dioxus-room-archive-subagent-badge = Subtask
dioxus-room-archive-searching = Searching...
dioxus-room-archive-search-fail = Failed to search sessions: 
dioxus-room-archive-search-empty = No matching sessions
...
dioxus-room-settings-mcp-readwrite = Read/Write Access
dioxus-room-settings-mcp-plugin = Philosophy Plugin
dioxus-room-settings-mcp-unauthorized = Unauthorized
dioxus-room-settings-workspace-path = E:\agent-project\northing\
dioxus-room-settings-display-breath = Biological Breath
dioxus-room-settings-display-breath-period = 8s Cycle
dioxus-room-settings-display-dual = Dual Optics
dioxus-room-settings-display-dual-note = Auto Light/Dark
dioxus-room-settings-sediment-foot = Abyss Level · Sealed
