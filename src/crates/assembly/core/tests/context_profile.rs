...
fn context_profile_long_task_policy_preserves_current_context_defaults() {
    let policy = ContextProfilePolicy::for_agent_context("DeepReview", false, ModelCapabilityProfile::Standard);
...
fn context_profile_conversation_policy_keeps_more_recent_chat_context() {
    let policy = ContextProfilePolicy::for_agent_context("Cowork", false, ModelCapabilityProfile::Standard);
...
fn context_profile_weak_model_override_shortens_contract_and_caps_fanout() {
    let standard = ContextProfilePolicy::for_agent_context("DeepReview", false, ModelCapabilityProfile::Standard);
    let weak = ContextProfilePolicy::for_agent_context("DeepReview", false, ModelCapabilityProfile::Weak);
...
fn context_profile_configured_subagent_concurrency_is_capped_by_policy() {
    let long_task = ContextProfilePolicy::for_agent_context("DeepReview", false, ModelCapabilityProfile::Standard);
    let conversation = ContextProfilePolicy::for_agent_context("Cowork", false, ModelCapabilityProfile::Standard);
