...
impl Perform for AnsiCleaner {
    ...
    fn csi_dispatch(&mut self, params: &Params, _intermediates: &[u8], _ignore: bool, c: char) {
        ...
        let param = params.iter().next().and_then(|group| group.iter().next()).unwrap_or(&1);
...
mod tests {
    ...
    fn test_cursor_forward() {
        ...
        let input = "d----           2026/1/10\x1b[16C.northhing";
        // "d----           2026/1/10" is 22 chars, cursor moves from col 22 to col 22+16=38
        // Since 38 > 22, spaces are padded to reach col 38, then ".northhing" is appended
        assert_eq!(strip_ansi(input), "d----           2026/1/10                .northhing");
    }
