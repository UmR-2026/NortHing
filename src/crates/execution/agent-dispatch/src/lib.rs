...
//!
//! - 1 const flag (`USE_LIGHTWEIGHT_ACTOR = true`); 3 Phase-3 IPC flags deleted
//!   2026-07-20 (descope)
//! - The `TelemetrySink` trait contract
//! - A `ToolDispatcher` port stub re-exported from `runtime-ports`
//! - `TokioSpawnAdapter` (in-process) spawn adapter
...
//! live scheduling) land in Phase 2.6+. **Phase 3 IPC (USE_ONESHOT_DISPATCHER /
//! USE_ACTOR_IPC / USE_DISPATCHER_IPC) officially descoped 2026-07-20.**
//!
//! ## Reference
//!
...
pub use flags::USE_LIGHTWEIGHT_ACTOR;
