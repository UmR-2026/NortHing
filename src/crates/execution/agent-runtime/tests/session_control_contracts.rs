use northhing_agent_runtime::session_control::{
    ...
    session_control_cancel_result_message, session_control_created_result_message, validate_session_control_input,
    SessionControlAction, SessionControlAgentType, SessionControlCancelRoute, SessionControlInput,
...
fn validates_create_requires_workspace_and_creator_session() {
    ...
    let missing_creator = validate_session_control_input(&input, SessionControlValidationContext::default());
