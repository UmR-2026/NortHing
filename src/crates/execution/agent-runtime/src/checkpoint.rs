...
pub fn build_light_checkpoint(touched_files: Vec<String>, workspace: LightCheckpointWorkspaceFacts) -> LightCheckpoint {
    match workspace {
...
mod tests {
    ...
    fn builds_local_checkpoint_summary_from_git_status_facts() {
        ...
        assert_eq!(checkpoint.dirty_state_summary, "staged=1, unstaged=2, untracked=3");
