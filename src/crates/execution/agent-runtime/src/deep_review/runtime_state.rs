...
use super::execution_policy::{DeepReviewExecutionPolicy, DeepReviewPolicyViolation, DeepReviewSubagentRole};
use super::queue::{
...
pub fn record_deep_review_task_budget(
    ...
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.record_task(parent_dialog_turn_id, policy, role, subagent_type, is_retry)
}
...
pub fn record_deep_review_runtime_queue_wait(parent_dialog_turn_id: &str, queue_elapsed_ms: u64) {
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.record_runtime_queue_wait(parent_dialog_turn_id, queue_elapsed_ms)
}
...
pub fn record_deep_review_runtime_provider_capacity_queue(
    ...
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.record_runtime_provider_capacity_queue(parent_dialog_turn_id, reason)
}
...
pub fn record_deep_review_runtime_provider_capacity_retry(
    ...
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.record_runtime_provider_capacity_retry(parent_dialog_turn_id, reason)
}
...
pub fn record_deep_review_runtime_provider_capacity_retry_success(
    ...
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.record_runtime_provider_capacity_retry_success(parent_dialog_turn_id, reason)
}

pub fn record_deep_review_runtime_capacity_skip(parent_dialog_turn_id: &str, reason: DeepReviewCapacityQueueReason) {
...
pub fn record_deep_review_runtime_auto_retry_suppressed(parent_dialog_turn_id: &str, reason: &str) {
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.record_runtime_auto_retry_suppressed(parent_dialog_turn_id, reason)
}
...
pub fn deep_review_runtime_diagnostics_snapshot(parent_dialog_turn_id: &str) -> Option<DeepReviewRuntimeDiagnostics> {
...
pub fn try_begin_deep_review_active_reviewer(
    ...
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER.try_begin_active_reviewer(parent_dialog_turn_id, max_active_reviewers)
}
...
pub fn record_deep_review_effective_concurrency_success(
    ...
    GLOBAL_DEEP_REVIEW_BUDGET_TRACKER
        .record_effective_concurrency_success(parent_dialog_turn_id, configured_max_parallel_instances)
}
