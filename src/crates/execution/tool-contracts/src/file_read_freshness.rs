...
pub fn file_read_facts_content_matches(read_facts: FileReadFreshnessFacts<'_>, current_content: &str) -> bool {
    read_facts.is_full_file_read
        && normalize_tool_file_content(current_content) == normalize_tool_file_content(read_facts.content)
}
