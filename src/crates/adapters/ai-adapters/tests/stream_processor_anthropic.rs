...
use common::stream_test_harness::{run_stream_fixture_with_options, StreamFixtureProvider, StreamFixtureRunOptions};
...
async fn anthropic_extended_thinking_sse_produces_reasoning_and_text() {
    ...
    assert_eq!(result.full_thinking, "Let me reason about this. Step by step.");
