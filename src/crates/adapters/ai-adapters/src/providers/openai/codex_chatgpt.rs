...
pub(crate) fn build_request_body(
    ...
    shared::log_request_body(TARGET, "Codex ChatGPT request body (excluding tools):", &body);
...
pub(crate) async fn send_stream(
    ...
    let request_body = build_request_body(client, instructions, response_input, tools_flat, extra_body);
