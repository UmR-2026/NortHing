...
use crate::dto::*;
use anyhow::Result;
use northhing_transport::TransportAdapter;
use std::sync::Arc;
...
/// Read file content
pub async fn handle_read_file(_state: &CoreAppState, request: ReadFileRequest) -> Result<ReadFileResponse> {
...
/// Write file content
pub async fn handle_write_file(_state: &CoreAppState, request: WriteFileRequest) -> Result<SuccessResponse> {
