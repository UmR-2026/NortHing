...
function updaterOutputName(file, version, platform) {
  ...
  if (lower.endsWith('.app.tar.gz')) {
    return `northhing_${version}_${platform}.app.tar.gz`;
  }
  if (lower.endsWith('.appimage')) {
    return `northhing_${version}_${platform}.AppImage`;
  }
  if (lower.endsWith('.zip')) {
    return `northhing_${version}_${platform}.zip`;
  }
  if (lower.endsWith('.exe')) {
    return `northhing_${version}_${platform}-setup.exe`;
  }
  if (lower.endsWith('.tar.gz')) {
    return `northhing_${version}_${platform}.tar.gz`;
  }
