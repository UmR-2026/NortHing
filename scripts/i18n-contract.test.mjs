...
auditIntegrationTest('web-ui uses shared terms for stable navigation and feature labels', { concurrency: false }, () => {
  ...
  try {
    ...
    const migratedResourceKeys = new Set([
      ...
      'common:remoteConnect.tabnorthhingServer',
    ...
    const legacyWebUiKeys = [
      ...
      'remoteConnect.title',
      'remoteConnect.tabnorthhingServer',
...
test('installer uses the shared product name for titlebar defaults', { concurrency: false }, () => {
  const appSource = readText('northhing-Installer/src/App.tsx');
  const localePaths = [
    'northhing-Installer/src/i18n/locales/en.json',
    'northhing-Installer/src/i18n/locales/zh.json',
    'northhing-Installer/src/i18n/locales/zh-TW.json',
  ];
