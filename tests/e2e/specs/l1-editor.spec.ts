...
describe('L1 Editor', () => {
  ...
  describe('Tab bar', () => {
    ...
    it('tabs should display file names', async function () {
      ...
      const tabs = await browser.$$('[role="tab"], .northhing-tab, [class*="tab-item"]');
  ...
  describe('Multi-tab operations', () => {
    ...
    it('tabs should have close buttons', async function () {
      ...
      const closeButtons = await browser.$$('[class*="tab-close"], .northhing-tab__close, [data-testid^="tab-close"]');
