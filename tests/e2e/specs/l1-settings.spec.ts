...
describe('L1 Settings', () => {
  ...
  describe('Settings panel opening', () => {
    it('settings button should be visible', async function () {
      ...
      const selectors = [
        ...
        '.northhing-header-right button',
        '.northhing-nav-bar__right button',
      ...
      if (!buttonFound) {
        ...
        const headerContainers = [
          '.northhing-header-right',
          '.northhing-nav-bar__right',
          '.northhing-nav-bar__controls',
          '.northhing-nav-bar',
        ];
      ...
      if (!buttonFound) {
        ...
        const header = await $('.northhing-nav-bar, .northhing-header');
    ...
    it('clicking settings button should open panel', async function () {
      ...
      const panel = await $('.northhing-config-center-panel');
  ...
  describe('Settings panel structure', () => {
    ...
    it('settings panel should have content area', async function () {
      ...
      const contentSelectors = [
        '.northhing-config-center-content',
  ...
  describe('Configuration modification', () => {
    it('settings should have form inputs', async function () {
      ...
      const inputs = await browser.$$('.northhing-config-center-panel input, .northhing-config-center-panel select, .northhing-config-center-panel textarea');
  ...
  describe('Settings panel closing', () => {
    it('settings panel should be closable', async function () {
      ...
      const backdrop = await $('.northhing-config-center-backdrop');
