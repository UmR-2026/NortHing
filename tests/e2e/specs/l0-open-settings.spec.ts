...
describe('L0 Settings Panel', () => {
  ...
  describe('Settings button location', () => {
    it('should find settings/config button', async function () {
      ...
      const moreBtn = await $('.northhing-nav-panel__footer-btn--icon');
      ...
      const menuItems = await $$('.northhing-nav-panel__footer-menu-item');
      ...
      // Close menu
      const backdrop = await $('.northhing-nav-panel__footer-backdrop');
  ...
  describe('Settings panel interaction', () => {
    it('should open and close settings panel', async function () {
      ...
      const settingsScene = await $('.northhing-settings-scene');
