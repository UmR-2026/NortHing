...
E2E test framework using WebDriverIO + the embedded northhing WebDriver.
...
The test runner starts northhing directly and waits for the embedded WebDriver service on `127.0.0.1:4445`.
